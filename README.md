...
- één Zendure Solarflow 2400 AC / Zendure Solarflow 800 Pro of Plus (geen aangesloten zonnepanelen). Of meerdere in combinatie met de [Node-RED proxy van Gast777](https://github.com/gast777/Zendure-zenSDK-proxy)
...
| `input_number.zendure_2400_ac_ontlaadmarge` | **(Instellingsadvies: 5 watt) 0-500 watt** – Geef hier aan hoeveel je extra wilt meenemen tijdens ontladen. Als je wat meer wilt ontladen dan noodzakelijk is | 
...
| `input_number.zendure_2400_ac_opladen_starten_bij` | **(Instellingsadvies: -100 watt) -100--1000 watt** – hier geef je aan wanneer de batterij exact begint met ontladen. Daarna balanceert de batterij naar 0 - de extra oplaadmarge  | 
| `input_number.zendure_2400_ac_oplaadmarge` | **(Instellingsadvies: 50 watt) 0-500 watt** – Geef hier aan hoeveel minder je wilt meenemen tijdens opladen. Als je wat minder wilt opladen, in de zomer met voldoende opwek zou je dit zelfs op 200 kunnen zetten om import overdag 100% te voorkomen. (Zendure zelf hanteert hier 50 watt in HEMS)  | 
